...
describe('Perform HTTP requests with corresponding HTTP methods', () => {
    ...
    it('it should make a GET request', async () => {
        const response: TailorResponse = await TailorFetch.GET('https://dummyjson.com/test', { json: true });
    ...
    it('it should make a POST request', async () => {
        const response: TailorResponse = await TailorFetch.POST('https://dummyjson.com/test', { json: true });
    ...
    it('it should make a PUT request', async () => {
        const response: TailorResponse = await TailorFetch.PUT('https://dummyjson.com/test', { json: true });
    ...
    it('it should make a PATCH request', async () => {
        const response: TailorResponse = await TailorFetch.PATCH('https://dummyjson.com/test', { json: true });
    ...
    it('it should make a DELETE request', async () => {
        const response: TailorResponse = await TailorFetch.DELETE('https://dummyjson.com/test', { json: true });
    ...
    it('it should make a OPTIONS request', async () => {
        const response: TailorResponse = await TailorFetch.OPTIONS('https://dummyjson.com/test', { json: true });
    ...
    it('it should make a HEAD request', async () => {
        const response: TailorResponse = await TailorFetch.HEAD('https://dummyjson.com/test', { json: true });
